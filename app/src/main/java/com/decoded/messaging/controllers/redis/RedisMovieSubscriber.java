...
@Service
public class RedisMovieSubscriber implements MessageListener {

    private String category;
    private SubscriberService subscriberService;

    public RedisMovieSubscriber(){}

    public RedisMovieSubscriber(String cat, SubscriberService subscriberService){
        this.category = cat;
